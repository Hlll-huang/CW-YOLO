    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if rank in [-1, 0]:
            ...
            if tb_writer:
                ...
                for x, tag in zip(list(mloss[:-1]) + list(new_results) + lr, tags):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolois.yaml', help='model.yaml path')
    ...
    parser.add_argument('--name', default='yolois', help='renames experiment folder exp{N} to exp{N}_{name} if supplied')
    ...
    parser.add_argument('--logdir', type=str, default='runs/train/VisDrone/', help='logging directory')
